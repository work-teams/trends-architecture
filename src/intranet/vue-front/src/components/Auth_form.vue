  ...
  <div class="container-form d-flex justify-content-center container my-4 shadow p-3 mb-5 bg-white rounded">
    <form @submit.prevent="validarDatos" id="login-form" class="w-100 p-4">
      <div class="mb-3">
        ...
        <input v-model="username" type="text" class="form-control form-control-sm" id="username" name="username"
          required />
      </div>
      <div class="mb-3">
        <label for="password" class="form-label">Contraseña:</label>
        <input v-model="password" type="password" class="form-control form-control-sm" id="password" name="password"
          required />
      </div>
