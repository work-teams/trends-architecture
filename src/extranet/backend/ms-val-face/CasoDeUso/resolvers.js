import {generateRandomHash, generateCurrentDate, generateCurrentTime, generateMensaje} from '../infrastructura/reniecAPI'

const admin = require("firebase-admin");
const firebaseConfig = require("../infrastructure/firebaseConfig"); // Cambia la ruta según la ubicación real de tu archivo de configuración
